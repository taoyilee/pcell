...
strCellName="ind_dualss";   The Cell Name is called inductor
...
cdfCreateParam(g_cdfDataId ?name "strName" ?type "string" ?defValue "ind_dualss" ?prompt "instance name" ?display "nil" ?editable "nil" 
...
g_cdfDataId->simInfo->auCdl = '( nil
        ...
        dollarParams      nil
        modelName         "ind_dualss"
        namePrefix        "L"
        propMapping       nil
        termOrder         (plus minus ctp ctn vss)
        componentName     ind_dualss
