...
strCellName="ind_sdualss";   The Cell Name is called inductor
...
;cdfCreateParam(g_cdfDataId ?name "OD" ?type "float" ?defValue 50.0 	?prompt "Outer Diameter" ?display "nil" ?editable "nil" ?storeDefault nil  ?callback "")
;cdfCreateParam(g_cdfDataId ?name "W" ?type "float" ?defValue 2.0 	?prompt "Line Width" ?display "nil" ?editable "nil" ?storeDefault nil  ?callback "")
...
cdfCreateParam(g_cdfDataId ?name "SS_Gap1" ?type "float" ?defValue 3.0	?prompt "Lead Opening" ?display "t" ?editable "t" ?storeDefault nil  ?callback "")
cdfCreateParam(g_cdfDataId ?name "SG_Gap1" ?type "float" ?defValue 4.0	?prompt "Lead Opening" ?display "t" ?editable "t" ?storeDefault nil  ?callback "")
cdfCreateParam(g_cdfDataId ?name "SS_Gap2" ?type "float" ?defValue 5.0	?prompt "Lead Opening" ?display "t" ?editable "t" ?storeDefault nil  ?callback "")
cdfCreateParam(g_cdfDataId ?name "SG_Gap2" ?type "float" ?defValue 6.0	?prompt "Lead Opening" ?display "t" ?editable "t" ?storeDefault nil  ?callback "")
...
g_cdfDataId->simInfo->auCdl = '( nil
        ...
        componentName     ind_sdualss
        instParameters    (od_str w_str)
        otherParameters   nil
        netlistProcedure  ansCdlSubcktCall
    )

 g_cdfDataId->paramLabelSet = "od_str w_str L1 R1 L2 R2 C12 CS1 CS5 RS5 CS3 CS7 RS7"
