...
strCellName="ind_duals";   The Cell Name is called inductor
...
cdfCreateParam(g_cdfDataId ?name "SG_Gap1" ?type "float" ?defValue 3.0	?prompt "Signal to Ground 1" ?display "t" ?editable "t" ?storeDefault nil  ?callback "")
cdfCreateParam(g_cdfDataId ?name "SG_Gap2" ?type "float" ?defValue 4.0	?prompt "Signal to Ground 2" ?display "t" ?editable "t" ?storeDefault nil  ?callback "")
cdfCreateParam(g_cdfDataId ?name "strName" ?type "string" ?defValue "ind_duals" ?prompt "instance name" ?display "nil" ?editable "nil" 
