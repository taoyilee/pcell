...
/* end modeling params */
cdfCreateParam(g_cdfDataId ?name "OD" ?type "float" ?defValue 190.0 	?prompt "Outer Diameter" ?display "t" ?editable "t" ?storeDefault nil  ?callback "")
cdfCreateParam(g_cdfDataId ?name "LOP" ?type "float" ?defValue 10.0 	?prompt "Pri. Lead Opening" ?display "t" ?editable "t" ?storeDefault nil  ?callback "")
...
cdfCreateParam(g_cdfDataId ?name "WO" ?type "float" ?defValue 4.0 	?prompt "Sec. Line Width" ?display "t" ?editable "t" ?storeDefault nil  ?callback "")
...
cdfCreateParam(g_cdfDataId ?name "DIVI" ?type "float" ?defValue 3.3 	?prompt "Pri. Shape Fine Tuning" ?display "t" ?editable "t" ?storeDefault nil  ?callback "")
cdfCreateParam(g_cdfDataId ?name "DIVO" ?type "float" ?defValue 3.35 	?prompt "Sec. Shape Fine Tuning" ?display "t" ?editable "t" ?storeDefault nil  ?callback "")
...
cdfCreateParam(g_cdfDataId ?name "balun_str" ?type "string" ?defValue "balun_ct" ?prompt "Text Label" ?display "cdfgData->dummy->value" ?editable "t" ?storeDefault nil  ?callback "")
