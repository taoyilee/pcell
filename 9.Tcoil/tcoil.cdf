...
strCellName="tcoil";   The Cell Name is called inductor
...
cdfCreateParam(g_cdfDataId ?name "OD" ?type "float" ?defValue 80.0 	?prompt "Outer Diameter" ?display "t" ?editable "t" ?storeDefault nil  ?callback "")
...
cdfCreateParam(g_cdfDataId ?name "S" ?type "float" ?defValue 3.0 	?prompt "Spacing" ?display "t" ?editable "t" ?storeDefault nil  ?callback "")
...
g_cdfDataId->simInfo->auCdl = '( nil
        ...
        componentName     ind_sym_cct
        instParameters    (OD NT W S L1A L1B)
        otherParameters   nil
