...
strCellName="ind_sdualpp";   The Cell Name is called inductor
...
g_cdfDataId->simInfo->auCdl = '( nil
        ...
        componentName     ind_sdualpp
        instParameters    (od_str w_str)
        otherParameters   nil
        netlistProcedure  ansCdlSubcktCall
    )

 g_cdfDataId->paramLabelSet = "OD W L1 R1 L2 R2 C12 CS1 CS5 RS5 CS3 CS7 RS7"
