...
strCellName="ind_sLpL";   The Cell Name is called inductor
...
cdfCreateParam(g_cdfDataId ?name "OD1" ?type "float" ?defValue 50.0 	?prompt "Outer Diameter (pL)" ?display "t" ?editable "t" ?storeDefault nil  ?callback "")
cdfCreateParam(g_cdfDataId ?name "OD2" ?type "float" ?defValue 50.0 	?prompt "Outer Diameter (sL)" ?display "t" ?editable "t" ?storeDefault nil  ?callback "")
